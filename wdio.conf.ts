...
export const automationArgs: Capabilities.ChromeOptions["args"] = [
  ...
  export const headlessArgs: Capabilities.ChromeOptions["args"] = [
    "--headless",
    "--disable-gpu",
    "--hide-scrollbars",
    "--log-level=1", // https://github.com/webdriverio-community/wdio-chromedriver-service/issues/43
    "--mute-audio"
  ];
...
export const config: WebdriverIO.Config = {
     ...
     * @param {Frameworks.Test}  test             test object
     * @param {Mocha.Context}  context          scope object the test was executed with
     * @param {Error}   result.error     error object in case the test fails, otherwise `undefined`
     * @param {Unknown}       result.result    return object of test function
